...
> **✅ PROMOTED to Paper E (2026-07-19)** — this line is now the founded **Paper E**, codename **"Smuggled Actions"**, namespace `agent_injection`. §5.1 (encoded indirect injection, attack-first) is the paper's core; §5.2 is the deliberately-later defense half. It took the E slot after `judge_reliability` parked (§9). Founding record: `text_docs/agent_injection/proposal.md`; roster: `text_docs/shared/papers.md`.
